...
- `FULL_NODE_BACKEND_ADDRESS` - This is set to one of the Coti nodes by default, but you change it to your own node if you want your node to process the transaction
